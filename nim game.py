    ...
    if canvas.find_withtag(CURRENT):
        ...
        try:
            if piece_name == "AI_first":
                ...
                canvas.create_text(360, 45, text="ILLEGAL MOVE", font="Purisa", tags="ILLEGAL_WARNING", fill="black",command=None)
                ...
                if piece_name == 'DONE' and last_piece != 'DONE' and last_piece != None:
                    ...
                    canvas.create_text(360, 45, text="YOU HAVE NOT MADE ANY MOVES", font="Purisa", tags="DOUBLE_DONE",fill="black", command=None)
                    canvas.update_idletasks()
                    canvas.after(1500)
...
def create_computer_go_first_button():
    canvas.create_rectangle(600,50,700,93,outline="black",fill="gray80",tags="AI_first")
